...
from Week4.lab_week4 import m_health_points
...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    belt.health_points = functions_lab05.use_loot(loot_options, belt)
    ...
    if num_dream_lvls != 0:
        health_points -= 1;
        crazy_level = functions_lab05.increase_level(num_dream_lvls)
