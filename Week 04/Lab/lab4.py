...
# Lab 04 - Q5
print("You find a loot bag! Look inside to find 3 items.")
...
input("Roll for the monsters magic power (Press Enter)")
...
print("The monster Combat Strength is now " + str(m_combat_strength) + "Using the " + power_roll + " magic")
